...
public class ActionContact implements Serializable, ToString2 {
  ...
  public static class Selector<TRoot extends com.kscs.util.jaxb.Selector<TRoot, ?>, TParent>
    ...
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> title = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> forename = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> surname = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> phoneNumber = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> emailAddress = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> ruName = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> tradingStyle = null;
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> forename() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> surname() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> phoneNumber() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> emailAddress() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> ruName() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> tradingStyle() {
