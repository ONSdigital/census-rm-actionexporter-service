...
public class ActionEvent implements Serializable, ToString2 {
        ...
        if (_copy) {
          ...
          if (_other.events == null) {
            ...
            for (String _item : _other.events) {
              this.events.add(((_item == null) ? null : new PrimitiveBuildable(_item)));
            }
          }
        } else {
          _storedValue = _other;
    ...
    public ActionEvent.Builder<_B> addEvents(final Iterable<? extends String> events) {
      if (events != null) {
        ...
        for (String _item : events) {
          this.events.add(new PrimitiveBuildable(_item));
        }
      }
      return this;
    }
  ...
  public static class Selector<TRoot extends com.kscs.util.jaxb.Selector<TRoot, ?>, TParent>
    ...
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> events = null;
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> events() {
