 ...
 *         &lt;element name="iacWales" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="qid" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="qidWales" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
public class ActionRequest extends Action implements Serializable, ToString2 {
  ...
  public ActionRequest(
      ...
      final String iac,
      final String iacWales,
      final String qid,
      final String qidWales,
    ...
    this.iac = iac;
    this.iacWales = iacWales;
    this.qid = qid;
    this.qidWales = qidWales;
    this.events = events;
  ...
  /**
   * Gets the value of the iacWales property.
   *
   * @return possible object is {@link String }
   */
  public String getIacWales() {
    return iacWales;
  }

  /**
   * Sets the value of the iacWales property.
   *
   * @param value allowed object is {@link String }
   */
  public void setIacWales(String value) {
    this.iacWales = value;
  }
  ...
  /**
   * Gets the value of the qidWales property.
   *
   * @return possible object is {@link String }
   */
  public String getQidWales() {
    return qidWales;
  }

  /**
   * Sets the value of the qidWales property.
   *
   * @param value allowed object is {@link String }
   */
  public void setQidWales(String value) {
    this.qidWales = value;
  }
  ...
  public <_B> void copyTo(final ActionRequest.Builder<_B> _other) {
    ...
    _other.iac = this.iac;
    _other.iacWales = this.iacWales;
    _other.qid = this.qid;
    _other.qidWales = this.qidWales;
  ...
  public <_B> void copyTo(
    ...
    final PropertyTree iacWalesPropertyTree =
        ((_propertyTree == null) ? null : _propertyTree.get("iacWales"));
    if (((_propertyTreeUse == PropertyTreeUse.INCLUDE)
        ? (iacWalesPropertyTree != null)
        : ((iacWalesPropertyTree == null) || (!iacWalesPropertyTree.isLeaf())))) {
      _other.iacWales = this.iacWales;
    }
    final PropertyTree qidPropertyTree =
        ((_propertyTree == null) ? null : _propertyTree.get("qid"));
    if (((_propertyTreeUse == PropertyTreeUse.INCLUDE)
        ? (qidPropertyTree != null)
        : ((qidPropertyTree == null) || (!qidPropertyTree.isLeaf())))) {
      _other.qid = this.qid;
    }
    final PropertyTree qidWalesPropertyTree =
        ((_propertyTree == null) ? null : _propertyTree.get("qidWales"));
    if (((_propertyTreeUse == PropertyTreeUse.INCLUDE)
        ? (qidWalesPropertyTree != null)
        : ((qidWalesPropertyTree == null) || (!qidWalesPropertyTree.isLeaf())))) {
      _other.qidWales = this.qidWales;
    }
  ...
  public boolean equals(Object object) {
    ...
    {
      String leftIacWales;
      leftIacWales = this.getIacWales();
      String rightIacWales;
      rightIacWales = that.getIacWales();
      if (this.iacWales != null) {
        if (that.iacWales != null) {
          if (!leftIacWales.equals(rightIacWales)) {
            return false;
          }
        } else {
          return false;
    ...
    }
    {
      ...
      leftQid = this.getQid();
      String rightQid;
      rightQid = that.getQid();
      if (this.qid != null) {
        if (that.qid != null) {
          if (!leftQid.equals(rightQid)) {
            return false;
          }
        } else {
          return false;
    ...
    {
      String leftQidWales;
      leftQidWales = this.getQidWales();
      String rightQidWales;
      rightQidWales = that.getQidWales();
      if (this.qidWales != null) {
        if (that.qidWales != null) {
          if (!leftQidWales.equals(rightQidWales)) {
            return false;
          }
        } else {
          return false;
  ...
  public int hashCode() {
    ...
    }
    {
      currentHashCode = (currentHashCode * 31);
      String theIacWales;
      theIacWales = this.getIacWales();
      if (this.iacWales != null) {
        currentHashCode += theIacWales.hashCode();
      }
    }
    {
      currentHashCode = (currentHashCode * 31);
      ...
      theQid = this.getQid();
      if (this.qid != null) {
        currentHashCode += theQid.hashCode();
      }
    }
    {
      currentHashCode = (currentHashCode * 31);
      String theQidWales;
      theQidWales = this.getQidWales();
      if (this.qidWales != null) {
        currentHashCode += theQidWales.hashCode();
      }
    }
    {
      currentHashCode = (currentHashCode * 31);
  ...
  public StringBuilder appendFields(
    ...
    }
    {
      String theIacWales;
      theIacWales = this.getIacWales();
      strategy.appendField(locator, this, "iacWales", buffer, theIacWales, (this.iacWales != null));
    }
    {
      String theQid;
      theQid = this.getQid();
      strategy.appendField(locator, this, "qid", buffer, theQid, (this.qid != null));
    }
    {
      String theQidWales;
      theQidWales = this.getQidWales();
      strategy.appendField(locator, this, "qidWales", buffer, theQidWales, (this.qidWales != null));
    }
    {
      ActionEvent theEvents;
      theEvents = this.getEvents();
  ...
  public static class Builder<_B> extends Action.Builder<_B> implements Buildable {
    ...
    public Builder(final _B _parentBuilder, final ActionRequest _other, final boolean _copy) {
      ...
      if (_other != null) {
        ...
        this.iac = _other.iac;
        this.iacWales = _other.iacWales;
        this.qid = _other.qid;
        this.qidWales = _other.qidWales;
    ...
    protected <_P extends ActionRequest> _P init(final _P _product) {
      ...
      _product.iacWales = this.iacWales;
      _product.qid = this.qid;
      _product.qidWales = this.qidWales;
    ...
    /**
     * Sets the new value of "iacWales" (any previous value will be replaced)
     *
     * @param iacWales New value of the "iacWales" property.
     */
    public ActionRequest.Builder<_B> withIacWales(final String iacWales) {
      this.iacWales = iacWales;
      return this;
    }

    /**
     * Sets the new value of "qid" (any previous value will be replaced)
     *
     * @param qid New value of the "qid" property.
     */
    public ActionRequest.Builder<_B> withQid(final String qid) {
      this.qid = qid;
      return this;
    }

    /**
     * Sets the new value of "qidWales" (any previous value will be replaced)
     *
     * @param qidWales New value of the "qidWales" property.
     */
    public ActionRequest.Builder<_B> withQidWales(final String qidWales) {
      this.qidWales = qidWales;
      return this;
    }
  ...
  public static class Selector<TRoot extends com.kscs.util.jaxb.Selector<TRoot, ?>, TParent>
    ...
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> actionPlan = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> actionType = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> questionSet = null;
    ...
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> legalBasis = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> region = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> respondentStatus = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> enrolmentStatus = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> caseGroupStatus = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> caseId = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> priority = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> caseRef = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> iac = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> iacWales = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> qid = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> qidWales = null;
    private ActionEvent.Selector<TRoot, ActionRequest.Selector<TRoot, TParent>> events = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> exerciseRef = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> userDescription = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> surveyName = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> surveyRef = null;
    private com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> returnByDate = null;
    ...
    public Map<String, PropertyTree> buildChildren() {
      ...
      if (this.iacWales != null) {
        products.put("iacWales", this.iacWales.init());
      }
      if (this.qid != null) {
        products.put("qid", this.qid.init());
      }
      if (this.qidWales != null) {
        products.put("qidWales", this.qidWales.init());
      }
      if (this.events != null) {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> actionPlan() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> actionType() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> questionSet() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> legalBasis() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> region() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> respondentStatus() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> enrolmentStatus() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> caseGroupStatus() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> iac() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> iacWales() {
      return ((this.iacWales == null)
          ? this.iacWales =
              new com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>>(
                  this._root, this, "iacWales")
          : this.iacWales);
    }

    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> qid() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> qidWales() {
      return ((this.qidWales == null)
          ? this.qidWales =
              new com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>>(
                  this._root, this, "qidWales")
          : this.qidWales);
    }
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> exerciseRef() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> userDescription() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> surveyName() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> surveyRef() {
    ...
    public com.kscs.util.jaxb.Selector<TRoot, Selector<TRoot, TParent>> returnByDate() {
