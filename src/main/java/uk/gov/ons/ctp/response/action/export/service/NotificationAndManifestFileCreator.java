...
public class NotificationAndManifestFileCreator {
    private static final Logger log = LoggerFactory.getLogger(NotificationAndManifestFileCreator.class);
    ...
    public void uploadData(
        ...
        writeFileToSftpAndRecordOnDB(manifestFileName, exportJob, manifestData, responseRequiredList, actionCount);
    }

    private void writeFileToSftpAndRecordOnDB(String filename, ExportJob exportJob, ByteArrayOutputStream data,
                                              String[] responseRequiredList, int actionCount) {
